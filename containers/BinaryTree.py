...
These two classes are the building blocks for the BST, AVLTree,
and Heap data structures.
It is crucial to get these implemented correctly in order to be
able to implement the other data structures.
'''
...
class BinaryTree():
    ...
    def print_tree(self, traversal_type):
        ...
        reference on how to write recursive functions on recursive data
        structures.
        '''
    ...
    def to_list(self, traversal_type):
        ...
        A general programming principle is that a function should
        return its results
        ...
        But by returning the results we can also do more computations on
        the results if needed.
        Many of the test cases for more complicated tree functions rely
        on this to_list function,
