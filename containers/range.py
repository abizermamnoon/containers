def range(a, b=None, c=None):
    ...
    built-in range function (without modifying the test cases!),
    then feel free to do so.
    That's fairly difficult to do, however, and it's much
    easier to just implement this function
    normally using the yield syntax.
    ...
    python code because it can remove some of the overhead of
